package learning.selenium.listners;
...
public class TestNGListners extends TestListenerAdapter implements IInvokedMethodListener {
	...
	public void afterInvocation(IInvokedMethod method, ITestResult result) {
		...
		if (method.isTestMethod()) {
			List<Throwable> verificationFailures = ErrorUtils.getVerificationFailures();
